...
(function(y) {
        ...
        for (var c = a.$$hashKey, f = 0, e = b.length; f < e; ++f) {
          ...
          if (E(g) || C(g))
            for (var h = Object.keys(g), k = 0, l = h.length; k < l; k++) {
              var m = h[k]
                  , n = g[m];
              d && E(n) ? ja(n) ? a[m] = new Date(n.valueOf()) : Za(n) ? a[m] = new RegExp(n) : n.nodeName ? a[m] = n.cloneNode(!0) : Sb(n) ? a[m] = n.clone() : (E(a[m]) || (a[m] = I(n) ? [] : {}),
                  Rb(a[m], [n], !0)) : a[m] = n
            }
        }
      ...
      function sa(a, b) {
        ...
        function c(a) {
          ...
          var b = !1
              , c = f(a);
          void 0 === c && (c = I(a) ? [] : Object.create(Bc(a)),
              b = !0);
          e.push(a);
          g.push(c);
          return b ? d(a, c) : c
      ...
      function Fc(a) {
        ...
        q((a || "").split("&"), function(a) {
          ...
          -1 !== c && (f = a.substring(0, c),
              ...
              f = Ec(f),
          x(f) && (e = x(e) ? Ec(e) : !0,
              ua.call(b, f) ? I(b[f]) ? b[f].push(e) : b[f] = [b[f], e] : b[f] = e))
        });
        return b
      }
      function Vb(a) {
      ...
      function se(a, b) {
        ...
        q(Oa, function(b) {
          b += "app";
          var f;
          !d && (f = a.querySelector("[" + b.replace(":", "\\:") + "]")) && (d = f,
              c = f.getAttribute(b))
        });
      ...
      function Gc(a, b, d) {
        ...
        y && f.test(y.name) && (d.debugInfoEnabled = !0,
      ...
      function xe() {
        ...
        if (!Ic) {
          var b = ub();
          (za = z(b) ? y.jQuery : b ? y[b] : void 0) && za.fn.on ? (F = za,
                  R(za.fn, {
                    scope: Pa.scope,
        ...
        if (e)
          if (b) {
            var g = function(b) {
              var c = f[b];
              x(d) && bb(c || [], d);
              x(d) && c && 0 < c.length || (a.removeEventListener(b, e, !1),
                  delete f[b])
            };
            ...
            for (b in f)
              "$destroy" !== b && a.removeEventListener(b, e, !1),
                  delete f[b]
      }
      function ib(a, b) {
        var d = a.ng339
            ...
            if (!m.get(a)) {
              ...
              try {
                D(a) ? (c = Wb(a),
                    ...
                    d(c._invokeQueue),
                    d(c._configBlocks)) : C(a) ? b.push(r.invoke(a)) : I(a) ? b.push(r.invoke(a)) : Qa(a, "module")
              } catch (e) {
      ...
      function mg(a, b, d, c) {
        ...
        ;
        var p, K, A = l.href, v = b.find("base"), N = null, L = c.history ? function() {
              try {
                return m.state
              } catch (a) {}
            }
          ...
          if (b) {
            ...
            !c.history || h && f ? (h || (N = b),
                d ? l.replace(b) : h ? (d = l,
                    ...
                    e = -1 === e ? "" : b.substr(e),
                    d.hash = e) : l.href = b,
            l.href !== b && (N = b)) : (m[d ? "replaceState" : "pushState"](e, "", b),
                g(),
                K = p);
            N && (N = b);
            return k
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, f, n, M, J, B, T, S) {
          ...
          function ca(a, b, c, d, e) {
            ...
            for (var f = /\S+/, g = 0, h = a.length; g < h; g++) {
              var k = a[g];
              k.nodeType === La && k.nodeValue.match(f) && Uc(k, a[g] = y.document.createElement("span"))
            }
            ...
            function g(a, c, d, e) {
              ...
              for (n = h.length; m < n; )
                k = A[h[m++]],
                    ...
                    f = h[m++],
                    c ? (c.scope ? (l = a.$new(),
                        ca.$$addScopeInfo(F(k), l)) : l = a,
                        s = c.transcludeOnThisElement ? G(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? G(a, b) : null,
                        c(f, l, k, d, s)) : f && f(a, k.childNodes, void 0, e)
            }
          ...
          function W(a, b, d, e, f, g, h, k, l) {
            ...
            function n(a, e, f, g, l) {
              ...
              u && (ca.$$addScopeInfo(P, M, !0, !(O && (O === u || O === u.$$originalDirective))),
              ...
              for (v = h.length; p < v; p++)
                B = h[p],
                    sa(B, B.isolateScope ? M : e, P, g, B.require && X(B.directiveName, B.require, P, J), S);
              var qa = e;
            ...
            for (var p = -Number.MAX_VALUE, A = l.newScopeDirective, r = l.controllerDirectives, u = l.newIsolateScopeDirective, O = l.templateDirective, M = l.nonTlbTranscludeDirective, T = !1, J = !1, H = l.hasElementTranscludeDirective, B = d.$$element = F(b), v, S, P, L = e, qa, x = !1, Ja = !1, w, y = 0, D = a.length; y < D; y++) {
              ...
              if (p > v.priority)
                break;
              if (w = v.scope)
                v.templateUrl || (E(w) ? ($("new/isolated scope", u || A, v, B),
                    u = v) : $("new/isolated scope", u, v, B)),
                    A = A || v;
              S = v.name;
              ...
              !v.templateUrl && v.controller && (r = r || V(),
                  $("'" + S + "' controller", r[S], v, B),
                  r[S] = v);
              if (w = v.transclude)
                if (T = !0,
                v.$$tlb || ($("transclusion", M, v, B),
                    M = v),
                "element" === w)
                  H = !0,
                      p = v.priority,
              ...
              v.terminal && (n.terminal = !0,
                  p = Math.max(p, v.priority))
            }
            n.scope = A && !0 === A.scope;
              ...
              for (var n = 0, p = h.length; n < p; n++)
                ...
                (z(g) || g > c.priority) && -1 !== c.restrict.indexOf(f)) {
                  ...
                  if (!c.$$bindings) {
                    ...
                    E(s.scope) && (!0 === s.bindToController ? (v.bindToController = d(s.scope, r, !0),
                        v.isolateScope = {}) : v.isolateScope = d(s.scope, r, !1));
          ...
          function ia(a, b, c, d, e, g, h, k) {
            ...
            return function(a, b, c, d, e) {
              a = e;
              b.$$destroyed || (l ? l.push(b, c, d, a) : (m.transcludeOnThisElement && (a = G(b, m.transclude, e)),
                  m(n, b, c, d, a)))
            }
          }
          function ja(a, b) {
          ...
          function la(a, c, d, e, f) {
            function g(b, c, e) {
              !C(d.$onChanges) || c === e || c !== c && e !== e || (da || (a.$$postDigest(P),
                  da = []),
              m || (m = {},
                  da.push(h)),
      ...
      function ed(a) {
        ...
        for (; b--; ) {
          var d = a[b];
          (8 === d.nodeType || d.nodeType === La && "" === d.nodeValue.trim()) && pg.call(a, b, 1)
        }
        return a
      }
      function ng(a, b) {
      ...
      function tf() {
        ...
        this.$get = ["$injector", "$window", function(d, c) {
          ...
          return function(e, g, h, k) {
            ...
            if (h)
              return h = (I(e) ? e[e.length - 1] : e).prototype,
      ...
      function zf() {
        ...
        this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(f, e, g, h, k, l) {
          ...
          function n(c, d) {
            ...
            J && (B = J.get(S),
                x(B) ? B && C(B.then) ? B.then(H, H) : I(B) ? n(B[1], B[0], ka(B[2]), B[3]) : n(B, 200, {}, "OK") : J.put(S, M));
            z(B) && ((B = od(c.url) ? e()[c.xsrfCookieName || a.xsrfCookieName] : void 0) && (T[c.xsrfHeaderName || a.xsrfHeaderName] = B),
                f(c.method, S, d, l, T, c.timeout, c.withCredentials, c.responseType, g(c.eventHandlers), g(c.uploadEventHandlers)));
            return M
          }
          function r(a, b) {
      ...
      function xf() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function(d, c, f) {
          ...
          function k(e, k, n, p) {
            ...
            A = e.length;
            for (var J = [], B = []; L < A; )
              if (-1 !== (v = e.indexOf(a, L)) && -1 !== (q = e.indexOf(b, v + l)))
      ...
      function jc(a, b, d) {
        ...
        this.$$parseLinkUrl = function(c, f) {
          ...
          var e, g;
          x(e = ra(a, c)) ? (g = e,
              g = d && x(e = ra(d, e)) ? b + (ra("/", e) || e) : a + g) : x(e = ra(b, c)) ? g = b + e : b === c + "/" && (g = b);
          g && this.$$parse(g);
          return !!g
        }
      }
      function kc(a, b, d) {
        ...
        this.$$parse = function(c) {
          ...
          z(f) || "#" !== f.charAt(0) ? this.$$html5 ? e = f : (e = "",
          z(f) && (a = c,
              this.replace())) : (e = ra(d, f),
          z(e) && (e = f));
          qd(e, this);
          c = this.$$path;
          var f = a
          ...
          e.on("click", function(a) {
            ...
            if (f && !a.ctrlKey && !a.metaKey && !a.shiftKey && 2 !== a.which && 2 !== a.button) {
              ...
              if (!D(f) || !z(h.attr(f))) {
                ...
                H.test(f) || !f || h.attr("target") || a.isDefaultPrevented() || !l.$$parseLinkUrl(f, k) || (a.preventDefault(),
              ...
              u = !1,
                  d.$evalAsync(function() {
                    ...
                    l.absUrl() === b && (c ? (l.$$parse(a),
                        l.$$state = e) : (m && h(b, g, e === l.$$state ? null : l.$$state),
                        k(a, e)))
                  });
            l.$$replace = !1
          });
      ...
      function Jb(a, b) {
        if (a && (a === ud || a === vd || a === wd || a === xd || a === yd || a === zd || a === Ag || a === Bg || a === Kb || a === Cg || a === Ad || a === Dg))
          throw ea("isecaf", b);
      }
      function Eg(a, b) {
      ...
      function Hf() {
        ...
        this.$get = ["$filter", function(e) {
          ...
          function k(a, b) {
            return null == a || null == b ? a === b : "object" === typeof a && (a = lc(a),
        ...
        R(g.prototype, {
          ...
          $$resolve: function(a) {
            ...
            try {
              if (E(a) || C(a))
                g = a && a.then;
              C(g) ? (this.promise.$$state.status = -1,
                  g.call(a, c, d, f(this, this.notify))) : (this.promise.$$state.value = a,
      ...
      function If() {
        ...
        this.$get = ["$exceptionHandler", "$parse", "$browser", function(e, g, h) {
          ...
          function l(a) {
            9 === Ia && (a.$$childHead && l(a.$$childHead),
          ...
          m.prototype = {
            ...
            $digest: function() {
              ...
              n("$digest");
              h.$$checkUrlChange();
              this === K && null !== f && (h.defer.cancel(f),
                  u());
              c = null;
              do {
                p = !1;
                ...
                for (r = 0; r < A.length; r++) {
                  try {
                    x = A[r],
                        x.scope.$eval(x.expression, x.locals)
                  } catch (z) {
                    e(z)
                  }
                  c = null
                    ...
                    for (r.$$digestWatchIndex = r.length; r.$$digestWatchIndex--; )
                      try {
                        if (a = r[r.$$digestWatchIndex])
                          if (m = a.get,
                          (g = m(q)) !== (k = a.last) && !(a.eq ? na(g, k) : ia(g) && ia(k)))
                            p = !0,
                                c = a,
      ...
      function Nf() {
        this.$get = ["$window", "$document", function(a, b) {
          ...
          if (l) {
            ...
            !f || m && n || (m = D(l.webkitTransition),
                n = D(l.webkitAnimation))
          }
          return {
            history: !(!c || 4 > f || e),
            hasEvent: function(a) {
        ...
        this.$get = ["$templateCache", "$http", "$q", "$sce", function(b, d, c, f) {
          function e(g, h) {
            ...
            return d.get(g, R({
              ...
              if (!h)
                throw Hg("tpload", g, a.status, a.statusText);
              return c.reject(a)
            })
          }
      ...
      function Og(a) {
        ...
        0 < (f = a.search(/e/i)) ? (0 > c && (c = f),
            c += +a.slice(f + 1),
            a = a.substring(0, f)) : 0 > c && (c = a.length);
        ...
        function c(a, b) {
          ...
          if (d === k) {
            ...
            "string" === d ? (k = k.toLowerCase(),
                l = l.toLowerCase()) : "object" === d && (E(k) && (k = a.index),
            E(l) && (l = b.index));
            k !== l && (c = k < l ? -1 : 1)
          } else
            c = d < k ? -1 : 1;
      ...
      function Xd(a) {
        function b(a, b) {
          b && !e[a] ? (k.addClass(f, a),
              e[a] = !0) : !b && e[a] && (k.removeClass(f, a),
              e[a] = !1)
        }
        function d(a, c) {
          a = a ? "-" + Hc(a, "-") : "";
      ...
      var gg = y.Node.prototype.contains || function(a) {
        ...
        ready: function(a) {
          ...
          var d = !1;
          "complete" === y.document.readyState ? y.setTimeout(b) : (this.on("DOMContentLoaded", b),
              W(y).on("load", b))
        },
        toString: function() {
          var a = [];
      ...
      q({
        ...
        W.prototype[b] = function(b, c, f) {
          for (var e, g = 0, h = this.length; g < h; g++)
            z(e) ? (e = a(this[g], b, c, f),
            x(e) && (e = F(e))) : Vc(e, a(this[g], b, c, f));
          return x(e) ? e : this
        }
      });
        ...
        readString: function(a) {
          ...
          for (var d = "", c = a, f = !1; this.index < this.text.length; ) {
            var e = this.text.charAt(this.index)
                , c = c + e;
            if (f)
              "u" === e ? (f = this.text.substring(this.index + 1, this.index + 5),
              f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"),
                  this.index += 4,
                  d += String.fromCharCode(parseInt(f, 16))) : d += bh[e] || e,
                  f = !1;
            else if ("\\" === e)
              f = !0;
            else {
      ...
      Gd.prototype = {
        ...
        recurse: function(a, b, d, c, f, e) {
          ...
          if (!e && x(a.watchId))
            b = b || this.nextId(),
                this.if_("i", this.lazyAssign(b, this.computedMember("i", a.watchId)), this.lazyRecurse(a, b, d, c, f, !0));
          else
            switch (a.type) {
              case t.Program:
                ...
                k.recurse(a.object, g, void 0, function() {
                  k.if_(k.notNull(g), function() {
                    ...
                    if (a.computed)
                      ...
                      f && 1 !== f && k.if_(k.not(k.computedMember(g, h)), k.lazyAssign(k.computedMember(g, h), "{}")),
      ...
      Hd.prototype = {
        ...
        recurse: function(a, b, d) {
          ...
          switch (a.type) {
            ...
            case t.Identifier:
              return Ua(a.name, e.expression),
                  e.identifier(a.name, e.expensiveChecks || Lb(a.name), b, d, e.expression);
            case t.MemberExpression:
              return c = this.recurse(a.object, !1, !!d),
              a.computed || (Ua(a.property.name, e.expression),
                  f = a.property.name),
              a.computed && (f = this.recurse(a.property)),
                  a.computed ? this.computedMember(c, f, b, d, e.expression) : this.nonComputedMember(c, f, e.expensiveChecks, b, d, e.expression);
            case t.CallExpression:
              return g = [],
                  q(a.arguments, function(a) {
                    g.push(e.recurse(a))
          ...
          return {
            ...
            link: function(d, c, f) {
              ...
              f.$observe(b, function(b) {
                b ? (f.$set(g, b),
                Ia && e && c.prop(e, f[g])) : "href" === a && f.$set(g, null)
              })
            }
          }
        }
      ...
      var je = {
        ...
        range: function(a, b, d, c, f, e) {
          ...
          function l(a) {
            s = qb(a);
            ia(c.$modelValue) || (m && c.$viewValue !== b.val() ? c.$setViewValue(b.val()) : c.$validate())
          }
          tc(a, b, d, c);
          Zd(c);
          Xa(a, b, d, c, f, e);
      ...
      var Re = ["$animate", "$compile", function(a, b) {
            ...
            return function(c, f, m, n, r) {
              ...
              c.$watch(e, function(e) {
                ...
                e ? (a(e, !0).then(function(a) {
                  ...
                  c.$$destroyed || u !== q || (z(),
                      c.$emit("$includeContentError", e))
                }),
                    c.$emit("$includeContentRequested", e)) : (z(),
                    n.template = null)
              })
            }
          }
        ...
        return {
          ...
          link: function(b, d, c, f) {
            ma.call(d[0]).match(/SVG/) ? (d.empty(),
                a(Tc(f.template, y.document).childNodes)(b, function(a) {
                  d.append(a)
                }, {
        ...
        this.$$updateEmptyClasses = function(a) {
          p.$isEmpty(a) ? (e.removeClass(c, "ng-not-empty"),
              e.addClass(c, "ng-empty")) : (e.removeClass(c, "ng-empty"),
              e.addClass(c, "ng-not-empty"))
        }
        ;
        var y = 0;
        Xd({
        ...
        this.$$runValidators = function(a, b, c) {
          ...
          (function() {
                ...
                if (z(u))
                  ...
                  return u || (q(p.$validators, function(a, b) {
                    f(b, null)
                  }),
        ...
        this.$$debounceViewValueCommit = function(b) {
          ...
          d && x(d.debounce) && (d = d.debounce,
              ba(d) ? c = d : ba(d[b]) ? c = d[b] : ba(d["default"]) && (c = d["default"]));
          g.cancel(t);
          c ? t = g(function() {
            p.$commitViewValue()
        ...
        return {
          ...
          controller: ["$scope", "$attrs", function(a, b) {
            ...
            x(this.$options.updateOn) ? (this.$options.updateOnDefault = !1,
                this.$options.updateOn = Y(this.$options.updateOn.replace(hh, function() {
          ...
          link: {
            ...
            post: function(d, h, k, l) {
              ...
              function n() {
                ...
                (C.trackBy || t ? na(a, b) : a === b) || (s.$setViewValue(b),
                    s.$render()))
              }
              ...
              C.trackBy && d.$watchCollection(function() {
                ...
                c ? (h[0].value !== c.selectValue && (y.remove(),
                    E(),
                    h[0].value = c.selectValue,
                    c.element.selected = !0),
                    c.element.setAttribute("selected", "selected")) : null === a || A ? (y.remove(),
                A || h.prepend(u),
                    h.val(""),
                v && (u.prop("selected", !0),
                    u.attr("selected", !0))) : (E(),
        ...
        return {
          link: function(e, g, h) {
            ...
            e.$watch(l, function(b) {
              ...
              c === A || f && ia(A) || (x(),
                  f = s[c],
                  z(f) ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + m),
                      x = w,
                      k()) : x = e.$watch(f, k),
                  A = c)
            })
            ...
            pre: function(a, b, d, c) {
              ...
              if (f) {
                ...
                if (d.multiple) {
                  ...
                  var g, h = NaN;
                  a.$watch(function() {
                    h !== f.$viewValue || na(g, f.$viewValue) || (g = ka(f.$viewValue),
                        f.$render());
                    h = f.$viewValue
                  });
      ...
      y.angular.bootstrap ? y.console && console.log("WARNING: Tried to load angular more than once.") : (xe(),
          ze($),
