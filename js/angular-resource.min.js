          ...
          function J(A, e, p, m) {
            function c(a, d) {
              ...
              u(d, function(d, e) {
                ...
                if (d && d.charAt && "@" === d.charAt(0)) {
                  f = a;
                  var l = d.substr(1);
                  if (null == l || "" === l || "hasOwnProperty" === l || !N.test("." + l))
                    throw y("badmember", l);
            ...
            u(p, function(a, d) {
              var b = /^(POST|PUT|PATCH)$/i.test(a.method)
                  , e = a.timeout
                  , g = K(a.cancellable) ? a.cancellable : s.defaults.cancellable;
              ...
              h[d] = function(f, l, m, A) {
                ...
                return D ? q : (n.$promise = q,
                    n.$resolved = !1,
                g && (n.$cancelRequest = x.resolve),
                    n)
              }
              ;
          ...
          B.prototype = {
            setUrlParams: function(b, e, g) {
              ...
              u(m.urlParams, function(a, b) {
                ...
                K(k) && null !== k ? (h = a.isQueryParamValue ? z(k, !0) : z(k, !0).replace(/%26/gi, "&").replace(/%3D/gi, "=").replace(/%2B/gi, "+"),
                    c = c.replace(new RegExp(":" + b + "(\\W|$)","g"), function(a, b) {
                      return h + b
              ...
              b.url = r + c.replace(/\/\\\./, "/.");
              u(e, function(a, c) {
                m.urlParams[c] || (b.params = b.params || {},
                    b.params[c] = a)
              })
            }
          };
