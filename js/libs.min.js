...
+function(t) {
  ...
  function r(r) {
    r && 3 === r.which || (t(n).remove(),
        t(a).each(function() {
          ...
          n.hasClass("open") && (r && "click" == r.type && /input|textarea/i.test(r.target.tagName) && t.contains(n[0], r.target) || (n.trigger(r = t.Event("hide.bs.dropdown", a)),
          r.isDefaultPrevented() || (o.attr("aria-expanded", "false"),
  ...
  i.VERSION = "3.3.7",
      i.prototype.toggle = function(o) {
        ...
        if (!n.is(".disabled, :disabled")) {
          ...
          if (r(),
            ...
            if (a.trigger(o = t.Event("show.bs.dropdown", d)),
      ...
      i.prototype.keydown = function(r) {
        if (/(37|39|38|40|27|32)/.test(r.which) && !/input|textarea/i.test(r.target.tagName)) {
          var o = t(this);
          if (r.preventDefault(),
              r.stopPropagation(),
            ...
            if (!i && 27 != r.which || i && 27 == r.which)
              return 27 == r.which && n.find(a).trigger("focus"),
                  o.trigger("click");
...
;/*! jQuery UI - v1.10.4 - 2015-01-09
* http://jqueryui.com
* Includes: jquery.ui.core.js, jquery.ui.widget.js, jquery.ui.mouse.js, jquery.ui.position.js, jquery.ui.draggable.js, jquery.ui.slider.js, jquery.ui.effect.js, jquery.ui.effect-slide.js
...
(function(e, t) {
      ...
      e.ui = e.ui || {};
      var n, o = Math.max, r = Math.abs, h = Math.round, l = /left|center|right/, u = /top|center|bottom/, d = /[\+\-]\d+(\.[\d]+)?%?/, c = /^\w+/, p = /%$/, f = e.fn.position;
      e.position = {
        scrollbarWidth: function() {
          if (n !== t)
            return n;
          var i, s, a = e("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"), o = a.children()[0];
        ...
        getWithinInfo: function(t) {
          ...
          e.fn.position = function(t) {
            ...
            t = e.extend({}, t);
            var n, p, m, g, v, y, b = e(t.of), _ = e.position.getWithinInfo(t.within), x = e.position.getScrollInfo(_), w = (t.collision || "flip").split(" "), k = {};
            return y = a(b),
            ...
            1 === w.length && (w[1] = w[0]),
                ...
                v.top += n[1],
                this.each(function() {
                  var a, l, u = e(this), d = u.outerWidth(), c = u.outerHeight(), f = s(this, "marginLeft"), y = s(this, "marginTop"), T = d + f + s(this, "marginRight") + x.width, D = c + y + s(this, "marginBottom") + x.height, S = e.extend({}, v), N = i(k.my, u.outerWidth(), u.outerHeight());
                  ...
                  t.using && (l = function(e) {
                        ...
                        d > p && p > r(i + s) && (h.horizontal = "center"),
                        c > m && m > r(a + n) && (h.vertical = "middle"),
                            h.important = o(r(i), r(s)) > o(r(a), r(n)) ? "horizontal" : "vertical",
          ...
          function() {
            var t, i, s, a, n, o = document.getElementsByTagName("body")[0], r = document.createElement("div");
          ...
          e.ui.plugin.add("draggable", "snap", {
            ...
            drag: function(t, i) {
              ...
              for (d = p.snapElements.length - 1; d >= 0; d--)
                r = p.snapElements[d].left,
                    h = r + p.snapElements[d].width,
                    l = p.snapElements[d].top,
                    u = l + p.snapElements[d].height,
                    r - m > v || g > h + m || l - m > b || y > u + m || !e.contains(p.snapElements[d].item.ownerDocument, p.snapElements[d].item) ? (p.snapElements[d].snapping && p.options.snap.release && p.options.snap.release.call(p.element, t, e.extend(p._uiHash(), {
                      snapItem: p.snapElements[d].item
                    })),
                        p.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = m >= Math.abs(l - b),
                        a = m >= Math.abs(u - y),
                        n = m >= Math.abs(r - v),
                        o = m >= Math.abs(h - g),
                    ...
                    !p.snapElements[d].snapping && (s || a || n || o || c) && p.options.snap.snap && p.options.snap.snap.call(p.element, t, e.extend(p._uiHash(), {
                      snapItem: p.snapElements[d].item
                    })),
                        p.snapElements[d].snapping = s || a || n || o || c)
            }
          }),
...
(function(e) {
      ...
      e.widget("ui.slider", e.ui.mouse, {
        ...
        _createHandles: function() {
          var t, i, s = this.options, a = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"), n = "<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>", o = [];
        ...
        _handleEvents: {
          keydown: function(i) {
            ...
            switch (o = this.options.step,
                a = n = this.options.values && this.options.values.length ? this.values(r) : this.value(),
                i.keyCode) {
              case e.ui.keyCode.HOME:
                n = this._valueMin();
                break;
        ...
        effect: {}
          ...
          function() {
            ...
            e.fn.addBack || (e.fn.addBack = function(e) {
                ...
                e.effects.animateClass = function(t, n, o, r) {
                  var h = e.speed(n, o, r);
                ...
                e.fn.extend({
                  ...
                  toggleClass: function(i) {
                    return function(s, a, n, o, r) {
                      return "boolean" == typeof a || a === t ? n ? e.effects.animateClass.call(this, a ? {
                        add: s
                      } : {
                        remove: s
                      }, n, o, r) : i.apply(this, arguments) : e.effects.animateClass.call(this, {
                        toggle: s
                      }, a, n, o)
                    }
                  }(e.fn.toggleClass),
              ...
              setTransition: function(t, i, s, a) {
                ...
                e.fn.extend({
                  effect: function() {
                    ...
                    return e.fx.off || !o ? a ? this[a](i.duration, i.complete) : this.each(function() {
...
;var localStorageConfMap = {}
$.cookie = function(key, val) {
  if (val == undefined) {
    return localStorageConf(key)
  } else {
    localStorageConf(key, val)
  }
}
var localStorageConf = function(key, val, del) {
  key = 'mg_' + key;
  if (del === true) {
    localStorage.removeItem(key)
    localStorageConfMap[key] == undefined;
  } else if (val !== undefined) {
    if (val && typeof val == 'object') {
      val = JSON.stringify(val)
    }
    localStorage.setItem(key, val)
    localStorageConfMap[key] = val;
  } else {
    val = localStorageConfMap[key]
    if (val == undefined) {
...
(function($, window, document, undefined) {
      ...
      $.fn.lazyload = function(options) {
        ...
        var settings = {
          ...
          load: null,
          error: null,
          proxy_url: "/MoticGallery/Proxy?url=",
        ...
        function getOrigin(res) {
          var index = res.indexOf("://");
          if (index !== -1) {
            return res.substring(0, res.indexOf("/", index + 3));
          }
          if (res.indexOf("//") === 0) {
            return location.protocol + res.substring(0, res.indexOf("/", 2))
          }
        }
        this.each(function() {
          var self = this;
          ...
          var appearFun = function() {
            if (!this.loaded) {
              ...
              $("<img />").bind("load", function() {
                ...
                if (isProxy) {
                  var ogl = $self.attr("data-" + settings.data_attribute);
                  sessionStorage.setItem("proxy_" + getOrigin(ogl), 1);
                }
                $self.hide();
                if ($self.is("img")) {
                ...
                if (settings.proxy_url && !isProxy && getOrigin($self.attr("data-" + settings.data_attribute)).indexOf(location.protocol + "//" + location.host) === -1) {
                  isProxy = true;
                  appearFun.call(self, $self, e);
                }
                if (settings.error) {
                  settings.error.call(self, $self, e);
                }
              }).attr("src", function() {
                var original = $self.attr("data-" + settings.data_attribute);
                if (original.indexOf("//") === 0) {
                  original = location.protocol + original;
                }
                if (isProxy || sessionStorage.getItem("proxy_" + getOrigin(original))) {
                  original = settings.proxy_url + encodeURIComponent(original);
                }
                return original;
              });
            }
          };
          $self.one("appear", appearFun);
          if (0 !== settings.event.indexOf("scroll")) {
      ...
      (function(t) {
            var n = e(this)
              ...
              var t = n.offset()
                ...
                y: r.y
                  ...
                  , a = {
                x: t.left,
                y: t.top + n.outerHeight() + c.tolerance
              }
                  , f = {
                x: t.left + n.outerWidth(),
                y: a.y
              ...
              if (!s)
                return 0;
              if (m || (m = s),
              m.x < t.left || m.x > f.x || m.y < t.top || m.y > f.y)
                return 0;
              if (u && s.x == u.x && s.y == u.y)
                return 0;
              function h(e, t) {
              ...
              var x = l
                  , v = f;
              "left" == c.submenuDirection ? (x = a,
                  v = r) : "below" == c.submenuDirection ? (x = f,
                  v = a) : "above" == c.submenuDirection && (x = r,
                  v = l);
              var y = h(s, x)
                  , p = h(s, v)
                  , b = h(m, x)
            ...
            n.mouseleave(function() {
              ...
              c.exitMenu(this) && (i && c.deactivate(i),
                  i = null)
            }).find(c.rowSelector).mouseleave(function() {
              c.exit(this)
            }).bind(c.eventName || "mouseenter", "click" == c.eventName ? l : function() {
                  r && clearTimeout(r);
                  c.enter(this),
                      a(this)
                }
