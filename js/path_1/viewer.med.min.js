...
var AnnotationList = function(y) {
  ...
  var html = '<div class="anno">' +
      '<a class="toolbutton active edit style-3" id="lnkHand" data-type="Hand">' +
      '<span class="toolbutton-inner toolbtn-icon-hand"></span>' +
      '</a>           ' +
      '<a class="toolbutton edit style-3" id="lnkSelect" data-type="Select">' +
      '<span class="toolbutton-inner toolbtn-icon-selectanno"></span>' +
      '</a>           ' +
      '<a class="toolbutton edit" data-type="CurveEditor">' +
      '<span class="toolbutton-inner toolbtn-icon-merge"></span>' +
      '</a>           ' +
      '<a class="toolbutton edit" data-type="PointMinus">' +
      '<span class="toolbutton-inner toolbtn-icon-minus"></span>' +
      '</a>           ' +
      '<div style="border-bottom: 1px solid #EBEBEB;" class="clearfix style-3"></div>          ' +
      /*' <a class="toolbutton style-3" id="lnkLine" data-type="Line">' +
      '<span class="toolbutton-inner toolbtn-icon-line"></span>' +
      '</a>           ' +
      '<a class="toolbutton style-3" id="lnkArrow" data-type="Arrow">' +
      '<span class="toolbutton-inner toolbtn-icon-arrow"></span>' +
      '</a>           ' +
      '<a class="toolbutton style-3"  id="lnkRect" data-type="Rectangle">' +
      '<span class="toolbutton-inner toolbtn-icon-rect"></span>' +
      '</a>           ' +
      '<a class="toolbutton style-3" id="lnkEllipse" data-type="Ellipse">' +
      '<span class="toolbutton-inner toolbtn-icon-ellipse"></span>' +
      '</a>           ' +
      '<a class="toolbutton" id="lnkCircle" data-type="Circle">' +
      '<span class="toolbutton-inner toolbtn-icon-circle"></span>' +
      '</a>           ' +*/
      '<a class="toolbutton task style-3" id="lnkCurveRounded" data-type="CurveRounded">' +
      '<span class="toolbutton-inner toolbtn-icon-curverounded"></span>' +
      '</a>           ' /*+
      '<a class="toolbutton" id="lnkCurve" data-type="Curve">' +
      '<span class="toolbutton-inner toolbtn-icon-curve"></span>' +
      '</a>           ' +
      '<a class="toolbutton" id="lnkAngle" data-type="Angle">' +
      '<span class="toolbutton-inner toolbtn-icon-angle"></span>' +
      '</a>           ' +
      '<a class="toolbutton" id="lnkArc" data-type="Arc">' +
      '<span class="toolbutton-inner toolbtn-icon-arc"></span>' +
      '</a>           ' +
      '<a class="toolbutton" id="lnkCircleThree" data-type="CircleThreePoints">' +
      '<span class="toolbutton-inner toolbtn-icon-circle3"></span>' +
      '</a>           ' +
      '<a class="toolbutton task" id="lnkPolygon" data-type="Polygon">' +
      '<span class="toolbutton-inner toolbtn-icon-polygon"></span>' +
      '</a>           ' +
      '<a class="toolbutton style-3" id="lnkRemark" data-type="Remark">' +
      '<span class="toolbutton-inner toolbtn-icon-remark"></span>' +
      '</a>           ' +
      '<a class="toolbutton" id="lnkPosition" data-type="Position">' +
      '<span class="toolbutton-inner toolbtn-icon-position"></span>' +
      '</a>';*/
/*  SlideViewerConfig.enableVoiceAnnotation && (html += '<a class="toolbutton " id="lnkVoiceAnnotation" data-type="VoiceAnnotation"><span class="toolbutton-inner toolbtn-icon-record"></span></a>'),*/
      html += /*'<div style="border-bottom: 1px solid #EBEBEB;" class="clearfix"></div>           ' +*/
          '<a class="toolbutton marquee task" id="lnkRectangleMarquee" data-type="RectangleMarquee">' +
          '<span class="toolbutton-inner toolbtn-roi-rect"></span>' +
          '</a>           ' +
          /*'<a class="toolbutton marquee" id="lnkPolygonMarquee" data-type="PolygonMarquee">' +
          '<span class="toolbutton-inner toolbtn-roi-polygon"></span>' +
          '</a>           ' +
          '<a class="toolbutton marquee" id="lnkCurveRoundedMarquee" data-type="CurveRoundedMarquee">' +
          '<span class="toolbutton-inner toolbtn-roi-curverounded"></span>' +
          '</a>           ' +*/
          '<div class="clearfix style-3"></div>           ' +
          '<label class="checkbox"><input type="checkbox" class="demo_ann">' +
          '<span data-lang="Labels.fluorescent"></span></label>           ' +
          '<label class="checkbox style-3" style="display: inline-block;margin-right:10px;">' +
          '<input type="checkbox" class="s_name"><span data-lang="Labels.s_name">' +
          '</label>           ' +
          '<label class="checkbox style-3" style="display: inline-block;">' +
          '<input type="checkbox" class="s_measurement">' +
          '<span data-lang="Labels.s_measurement">' +
          '</label>           ' +
          '<label class="checkbox style-3" >' +
          '<input type="checkbox" class="ann_list">' +
          '<span data-lang="Labels.ann_list"></span>' +
          '</label>           ' +
          '<label class="checkbox style-3">' +
          '<input type="checkbox" class="measurement">' +
          '<span data-lang="Labels.show_measurement"></span>' +
          '</label>           ' +
          '<p style="border-bottom:1px solid #EBEBEB;color: #aaa;text-align: center;line-height: 3px;">' +
          '<span style="display:none;background: white;padding: 0 5px;">App</span>' +
          '</p>            ' +
          '<label class="radio">               ' +
          '<input type="radio" name="visible" value="1" checked="">               ' +
          '<span data-lang="visible.public"></span>            ' +
          '</label>            ' +
          '<label class="radio">               ' +
          '<input type="radio" name="visible" value="5">               ' +
          '<span data-lang="visible.admin"></span>            ' +
          '</label>            ' +
          '<label class="radio">               ' +
          '<input type="radio" name="visible" value="0">               ' +
          '<span data-lang="visible.private"></span>            ' +
          '</label>           ' +
          '<p class="border-top"></p>           ' +
          '<div class="text-right style-3">           ' +
          '<span id="ann_status" style="margin-right:10px;color:#777;font-size:90%;"></span>           ' +
          '<a class="btn btn-primary hidden" id="lnkSave1" data-lang="Buttons.Save"></a>           ' +
          '<a class="btn btn-primary" id="lnkEdit" data-lang="Buttons.Edit"></a>           ' +
          '<a class="btn btn-danger" id="lnkDelete" data-lang="Buttons.Delete"></a>           ' +
          '</div>           ' +
          '<div class="compactshade">' +
          '<span class="suport" data-lang="Compact.Message"></span>' +
          '</div>           ' +
          '<div class="canvas">' +
          '<span class="suport" data-lang="Labels.NotSupported"></span>' +
          '</div>        ' +
          '</div>';
